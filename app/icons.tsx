...
export function LinkCard({
  ...
  return (
    <a
      ...
      className="flex items-center p-3 w-full rounded-full transition-all bg-[#e7e7eb] mb-3 max-w-3xl"
    >
      <div className="flex text-center w-full">
        <h2 className="flex justify-center items-center font-mono w-full text-gray-700">
          {title}
        </h2>
      </div>
    </a>
